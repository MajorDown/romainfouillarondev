const SeoSection = () => {
  return /*html*/ `
        <section id="seoSection" class="serviceSection">
            ...
            <div class="sectionContent">
                <div class="content r2">
                    <h3>un Audit SEO</h3>
                    <p>Après des mois et des mois de fouinage, de creusage de méninges et de tests, j'ai fini par établir un plan d'audit que j'ai requalifié en 3 étapes : "interne", "externe", et "objectif"</p>
                    <p>Cette méthode me permet de lister l'ordre de priorité des modifications à apporter de manière beaucoup plus objective (d'ou le nom de la dernière étape)</p>
                    <p>Pour plus d'informations spécifiques, n'hésitez pas à me contacter !</p>
                </div>
            </div>
            <div class="sectionContent">
                <div class="content r1">
